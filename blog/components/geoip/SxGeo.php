...
namespace blog\components\geoip;
...
class SxGeo {
	...
	public function __construct($db_file = 'kostikpenzin/yii2-geoip/SxGeoCity.dat', $type = SXGEO_FILE){
		$this->fh = fopen(\Yii::getAlias('@vendor').'/'.$db_file, 'rb');
